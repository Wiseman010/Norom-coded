...
const searhchBarEl = document.querySelector('.search-bar');
...
function handleScroll() {
  // Check if screen width is under 768px (standard tablet/mobile breakpoint)
  if (window.innerWidth < 768) {
    ...
    mybutton.style.display = "none"; // Always hide on desktop
  }
}
